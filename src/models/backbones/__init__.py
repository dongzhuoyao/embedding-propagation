...
def get_backbone(backbone_name, exp_dict):
    ...
    elif backbone_name == 'wrn50_2':
        from src.models.backbones.pytorch_backbone import wrn50_2
        backbone = wrn50_2(dropout=exp_dict["dropout"])
    elif backbone_name == 'resnet50':
        from src.models.backbones.pytorch_backbone import resnet50
        backbone = resnet50(dropout=exp_dict["dropout"])
    elif backbone_name == 'densenet121':
        from src.models.backbones.pytorch_backbone import densenet121
        backbone = densenet121(dropout=exp_dict["dropout"])
    else:raise
    return backbone
