...
EXP_GROUPS = {"finetune_tieredin_wrn": []}


for dataset in [tiered_imagenet]:#[miniimagenet, tiered_imagenet, cub]:
            ...
            for shot in [5]:#[1, 5]:
                    for train_iters in [600]:#[100, 600]:
                        for classification_weight in [0.1]:#[0, 0.1, 0.5]:
                            EXP_GROUPS['finetune_tieredin_wrn'] += [{"model": backbone,
                                                        ...
                                                        "test_iters": 1000,
                                                        "tasks_per_batch": 1,
                                                        "pretrained_weights_root": "./logs/pretrain_tieredin_wrn",
