                    ...
                    for train_iters in [600]:#[100, 600]:
                        for classification_weight in [0.1]:#[0, 0.1, 0.5]:
                            EXP_GROUPS['finetune_miniin_wrn50_2'] += [{"model": backbone,
                                                        ...
                                                        "test_iters": 1000,
                                                        "tasks_per_batch": 1,
                                                        "pretrained_weights_root": "./logs/pretrain_miniin_wrn50_2",
